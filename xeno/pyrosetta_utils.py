...
# dalphaball_path = ""
# pyrosetta.init(f'-ignore_unrecognized_res -ignore_zero_occupancy -mute all -holes:dalphaball {dalphaball_path} -corrections::beta_nov16 true -relax:default_repeats 1')
pyrosetta.init(f'-ignore_unrecognized_res -ignore_zero_occupancy -mute all -corrections::beta_nov16 true -relax:default_repeats 1')
...
def score_interface(structure_file_path, binder_chain="B"):
    # load pose
    # pose = pyrosetta.pose_from_pdb(pdb_file)
    pose = pyrosetta.pose_from_file(structure_file_path)
    ...
    interface_residues_set = hotspot_residues(structure_file_path, binder_chain)
...
def align_pdbs(reference_pdb, align_pdb, reference_chain_id, align_chain_id):
    # initiate poses
    reference_pose = pyrosetta.pose_from_pdb(reference_pdb)
    align_pose = pyrosetta.pose_from_pdb(align_pdb)
    ...
    reference_chain = pyrosetta.rosetta.core.pose.get_chain_id_from_chain(reference_chain_id, reference_pose)
    align_chain = pyrosetta.rosetta.core.pose.get_chain_id_from_chain(align_chain_id, align_pose)
...
def unaligned_rmsd(reference_pdb, align_pdb, reference_chain_id, align_chain_id):
    ...
    reference_chain_pose = pyrosetta.Pose()
    align_chain_pose = pyrosetta.Pose()
